...
/**
 * @brief Constructor de conversión de la clase Fecha
 * @details Constructor de conversión de la clase Fecha
 * @param fecha Fecha a convertir
 * @return Fecha en formato cadena de caracteres
 */
...
/**
 * @brief Operador de inserción de la clase Fecha
 * @details Imprime la fecha en el flujo de salida
 * @param os Flujo de salida
 * @param f Fecha a imprimir
...
/**
 * @brief Operador de extracción de la clase Fecha
 * @details Lee una fecha del flujo de entrada
 * @param is Flujo de entrada
 * @param f Fecha a leer
 * @return istream& Flujo de entrada
 */
std::istream &operator>>(std::istream &is, Fecha &f) {
    char *cad_aux = new char[11];
    is.width(11);
    is >> cad_aux;
    try {
        f = cad_aux;
        ...
        delete[] cad_aux;
        throw Fecha::Invalida("Operador >>: Formato de fecha incorrecto.");
    }
    delete[] cad_aux;
    return is;
}